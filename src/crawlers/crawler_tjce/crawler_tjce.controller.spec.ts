          ...
          movimentacoesLista: [
            {
              data: '16/08/2022',
              movimento:
                'Juntada de OfícioNº Protocolo: WEB1.22.02299977-0Tipo da Petição: OfícioData: 16/08/2022 12:49',
            },
            {
              data: '16/09/2021',
            ...
            },
            {
              data: '24/08/2016',
              movimento:
                ' Proferido despacho de mero expedienteSolicite-se o cumprimento da carta precatória de pág. 281 por intermédio da Corregedoria Geral da Justiça do Estado do Ceará. Oficie-se para essa finalidade.',
            },
            {
              data: '23/08/2016',
              movimento: 'Concluso para Despacho',
            ...
            },
            {
              data: '18/08/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10377382-2Tipo da Petição: Pedido de Juntada de DocumentoData: 17/08/2016 18:29',
            },
            {
              data: '09/08/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10361896-7Tipo da Petição: RECURSO DE APELAÇÃOData: 08/08/2016 18:17',
            },
            {
              data: '28/06/2016',
              movimento: 'Juntada de documento',
            ...
            },
            {
              data: '23/06/2016',
              movimento:
                ' Proferido despacho de mero expedienteVisto em inspeção ordinária - Portaria nº 01/2016.Oficie-se ao Juízo deprecado solicitando o cumprimento da carta precatória, no prazo de trinta(30) dias..',
            },
            {
              data: '13/05/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10209425-5Tipo da Petição: Contrarrazões RecursaisData: 13/05/2016 19:17',
            },
            {
              data: '26/04/2016',
              movimento: ' Certidão emitida',
            ...
            },
            {
              data: '13/04/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10158782-7Tipo da Petição: RECURSO DE APELAÇÃOData: 13/04/2016 20:11',
            },
            {
              data: '09/04/2016',
              movimento: ' Certidão emitida',
            ...
            },
            {
              data: '22/03/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10122590-9Tipo da Petição: Embargos de DeclaraçãoData: 21/03/2016 22:08',
            },
            {
              data: '22/03/2016',
              movimento:
                'Processo entranhadoEntranhado o processo 0070337-91.2008.8.06.0001/01 - Classe: Embargos de Declaração em Ação Penal - Procedimento Ordinário - Assunto principal: Crimes de Trânsito',
            },
            {
              data: '22/03/2016',
            ...
            },
            {
              data: '03/03/2016',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.16.10092085-9Tipo da Petição: MemoriaisData: 03/03/2016 09:58',
            },
            {
              data: '19/11/2015',
              movimento: ' Certidão emitida',
            ...
            },
            {
              data: '15/10/2014',
              movimento:
                'Juntada de PetiçãoNº Protocolo: WEB1.14.71565572-1Tipo da Petição: MemoriaisData: 15/10/2014 18:11',
            },
            {
              data: '10/10/2014',
              movimento:
                'Juntada de Carta Precatória/RogatóriaNº Protocolo: PROT.14.01353297-0Tipo da Petição: Retorno de Carta PrecatóriaData: 06/10/2014 12:54Complemento: Acompanha mídia original(CD).',
            },
            {
              data: '17/07/2014',
              movimento: 'Juntada de Ofício',
            ...
            },
            {
              data: '27/11/2013',
              movimento:
                'Audiência de instrução e julgamento designadaAUDIÊNCIA DE INSTRUÇÃO E JULGAMENTO DESIGNADA DATA DA AUDIENCIA: 04/02/2014HORA DA AUDIENCIA: 11:20 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '29/07/2013',
              movimento:
                'Juntada de documentoJUNTADA DE DOCUMENTO TIPO DE DOCUMENTO: DESPACHO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '24/07/2013',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '24/07/2013',
              movimento:
                'Juntada de documentoJUNTADA DE DOCUMENTO TIPO DE DOCUMENTO: PARECER MP - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '24/07/2013',
              movimento:
                'Recebidos os autosRECEBIDOS OS AUTOS DE QUEM: MPPROVENIENTE DE : CARGA/VISTA - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '11/07/2013',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoAUTOS ENTREGUES COM CARGA/VISTA AO MINISTÉRIO PÚBLICO NOME DO DESTINATÁRIO: DRA. MARIA DO CARMOFUNCIONARIO: NEHYSE LIMANO. DAS FOLHAS: 00DATA INICIAL DO PRAZO: 11/07/2013 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '20/05/2013',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoVISTA P/ CIÊNCIA DO MP - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '20/05/2013',
              movimento:
            ...
            },
            {
              data: '17/05/2013',
              movimento:
                'Juntada de documentoJUNTADA DE DOCUMENTO TIPO DE DOCUMENTO: PARECER DEFENSOR PUBLICO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '17/05/2013',
              movimento:
            ...
            },
            {
              data: '17/05/2013',
              movimento:
                'Recebidos os autosRECEBIDOS OS AUTOS DE QUEM: DEFENSOR PUBLICOPROVENIENTE DE : CARGA/VISTA - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '14/05/2013',
              movimento:
                'Autos entregues com carga/vista ao defensor públicoAUTOS ENTREGUES COM CARGA/VISTA AO DEFENSOR PÚBLICO NOME DO DESTINATÁRIO: DR. ATHILA BEZERRA FUNCIONARIO: NEHYSE LIMANO. DAS FOLHAS: 00DATA INICIAL DO PRAZO: 14/05/2013DATA FINAL DO PRAZO: 19/05/2013 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '28/08/2012',
              movimento:
            ...
            },
            {
              data: '23/08/2012',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO COM RESPOSTA Á ACUSAÇÃO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '23/08/2012',
              movimento:
            ...
            },
            {
              data: '21/08/2012',
              movimento:
                'Autos entregues com carga/vista ao defensor públicoAUTOS ENTREGUES COM CARGA/VISTA AO DEFENSOR PÚBLICO NOME DO DESTINATÁRIO: Dr LinoFUNCIONARIO: albertoNO. DAS FOLHAS: 95DATA INICIAL DO PRAZO: 22/08/2012DATA FINAL DO PRAZO: 26/08/2012 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '10/07/2012',
              movimento:
                'Entrada de petição de acompanhamentoENTRADA DE PETIÇÃO DE ACOMPANHAMENTO Objeto Peticao : - Local Entrada :SERVIÇO DE PORTARIA DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA ( COMARCA DE FORTALEZA ) - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '19/12/2011',
              movimento:
                'Expedição de documentoEXPEDIÇÃO DE DOCUMENTO TIPO DE DOCUMENTO: CARTA PRECATÓRIA ENVIAR - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '16/12/2011',
              movimento:
                'Expedição de documentoEXPEDIÇÃO DE DOCUMENTO TIPO DE DOCUMENTO: OFÍCIO SELAR EXPEDIENTES - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '28/11/2011',
              movimento:
                'Expedição de documentoEXPEDIÇÃO DE DOCUMENTO TIPO DE DOCUMENTO: MANDADO DE CITAÇÃO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '16/11/2011',
              movimento:
                'AutuaçãoAUTUAÇÃO DOCUMENTO ATUAL: DENÚNCIA - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '31/10/2011',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO COM DENÚNCIA - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '31/10/2011',
              movimento:
            ...
            },
            {
              data: '31/10/2011',
              movimento:
                'Recebida a denúnciaRECEBIDA A DENÚNCIA Inquerito transformado em Processo - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '24/10/2011',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoAUTOS ENTREGUES COM CARGA/VISTA AO MINISTÉRIO PÚBLICO NOME DO DESTINATÁRIO: DR. BRUNO JORGEFUNCIONARIO: MARTA ESDRASNO. DAS FOLHAS: 1DATA INICIAL DO PRAZO: 24/10/2011 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '23/09/2011',
              movimento:
            ...
            },
            {
              data: '22/06/2011',
              movimento:
                'Remessa dos autosREMESSA DOS AUTOS DESTINO: À DELEGACIA 8º DP - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '23/05/2011',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO DILIGÊNCIAS - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '21/03/2011',
              movimento:
            ...
            },
            {
              data: '07/06/2010',
              movimento:
                'Expedição de documentoEXPEDIÇÃO DE DOCUMENTO TIPO DE DOCUMENTO: OFÍCIO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '27/05/2010',
              movimento:
            ...
            },
            {
              data: '17/05/2010',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoAUTOS ENTREGUES COM CARGA/VISTA AO MINISTÉRIO PÚBLICO NOME DO DESTINATÁRIO: DR. BRUNO JORGEFUNCIONARIO: MARTA ESDRASNO. DAS FOLHAS: 2DATA INICIAL DO PRAZO: 17/05/2010 - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '17/03/2009',
              movimento:
                'Redistribuição por encaminhamentoREDISTRIBUIÇÃO POR ENCAMINHAMENTO Distribuído automaticamente conforme provimento nº04/2009 circulado no Diário da Justiça em 22/01/2009. Motivo: TRANSFORMAÇÃO 1ª VARA DO TRÂNSITO EM VARA ÚNICA DO TRÂNSITO - Local: VARA ÚNICA DE TRÂNSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '10/03/2009',
              movimento:
                'Entrada de petição de acompanhamentoENTRADA DE PETIÇÃO DE ACOMPANHAMENTO Objeto Peticao : - Local Entrada :SERVIÇO DE PORTARIA DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA ( COMARCA DE FORTALEZA ) - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '27/02/2009',
              movimento:
            ...
            },
            {
              data: '20/02/2009',
              movimento:
                'Remessa dos autosREMESSA DOS AUTOS DESTINO: 8º DP. p/ diligências - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '09/02/2009',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '19/01/2009',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoAUTOS ENTREGUES COM CARGA/VISTA AO MINISTÉRIO PÚBLICO NOME DO DESTINATÁRIO: DR. BRUNO JORGEFUNCIONARIO: MARTA ESDRASNO. DAS FOLHAS: 31DATA INICIAL DO PRAZO: 19/01/2009 - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '16/01/2009',
              movimento:
                'Concluso ao juizCONCLUSO AO JUIZ TIPO DE CONCLUSÃO: DESPACHO/DECISÃO vindos do 8º DP - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '27/11/2008',
              movimento:
                'Autos entregues com carga/vista ao ministério públicoAUTOS ENTREGUES COM CARGA/VISTA AO MINISTÉRIO PÚBLICO NOME DO DESTINATÁRIO: DR. BRUNO JORGEFUNCIONARIO: MARTA ESDRASNO. DAS FOLHAS: 18DATA INICIAL DO PRAZO: 27/11/2008 - Local: 1ª VARA DE TRANSITO DA COMARCA DE FORTALEZA',
            },
            {
              data: '19/08/2008',
              movimento:
                'Remessa à delegacia de origemREMESSA À DELEGACIA DE ORIGEM DELEGACIA: 8° DP - Local: CENTRAL DE INQUERITOS',
            },
            {
              data: '14/07/2008',
              movimento:
                'Entregue ao promotor de justiçaENTREGUE AO PROMOTOR DE JUSTIÇA PROMOTOR: DRA. MORGANA - Local: CENTRAL DE INQUERITOS',
            },
            {
              data: '11/07/2008',
              movimento:
                'Distribuição automáticaDISTRIBUIÇÃO AUTOMÁTICA DISTRIBUIÇÃO AUTOMÁTICA Motivo : EQÜIDADE. - - Local: SERVIÇO DE DISTRIBUIÇAO DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA',
            },
            {
              data: '11/07/2008',
              movimento:
                'Permitir distribuiçãoPERMITIR DISTRIBUIÇÃO - Local: SERVIÇO DE DISTRIBUIÇAO DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA',
            },
            {
              data: '11/07/2008',
              movimento:
                'Em classificaçãoEM CLASSIFICAÇÃO - Local: SERVIÇO DE DISTRIBUIÇAO DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA',
            },
            {
              data: '10/07/2008',
              movimento:
                'ProtocoladoPROTOCOLADO - Local: SERVIÇO DE PORTARIA DOS FEITOS JUDICIAIS DA COMARCA DE FORTALEZA',
            },
          ],
        },
        segundaInstancia: {
